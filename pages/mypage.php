        ...
        <div class="col-md-6 offset-2">
            ...
            foreach ($allPost as $post) {
                ...
                <div class="card my-3">
                    ...
                    -->
                        <a href="/pages/blog.php?id=<?php echo $post['id'] ?>" class="btn btn-primary">Read More</a>
                        <a href="/pages/edit.phpit.php?id=<?php echo $post['id'] ?>" class="btn btn-info">Edit</a>
                        <a href="/pages/delete.phpte.php?id=<?php echo $post['id'] ?>" class="btn btn-danger">Delete</a>
                    </div>
